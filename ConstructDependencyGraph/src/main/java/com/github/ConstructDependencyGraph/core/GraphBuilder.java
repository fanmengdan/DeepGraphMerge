package com.github.ConstructDependencyGraph.core;

import com.github.ConstructDependencyGraph.core.visitor.MemberVisitor;
import com.github.ConstructDependencyGraph.core.visitor.MyNodeFinder;
import com.github.ConstructDependencyGraph.model.DiffFile;
import com.github.ConstructDependencyGraph.model.DiffHunk;
import com.github.ConstructDependencyGraph.model.EntityPool;
import com.github.ConstructDependencyGraph.model.constant.Version;
import com.github.ConstructDependencyGraph.model.entity.DeclarationInfo;
import com.github.ConstructDependencyGraph.model.entity.FieldInfo;
import com.github.ConstructDependencyGraph.model.entity.HunkInfo;
import com.github.ConstructDependencyGraph.model.entity.MethodInfo;
import com.github.ConstructDependencyGraph.model.graph.Edge;
import com.github.ConstructDependencyGraph.model.graph.EdgeType;
...
import com.github.ConstructDependencyGraph.util.JDTService;
import com.github.ConstructDependencyGraph.util.NameResolver;
...
public class GraphBuilder implements Callable<Graph<Node, Edge>> {
  ...
  private void createHunkInfos(
    ...
    for (String index : hunksPosition.keySet()) {
      ...
      hunkNode.diffhunkID = diffHunk.getDiffHunkID();
