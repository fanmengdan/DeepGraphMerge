package com.github.ConstructDependencyGraph.util;

import com.github.ConstructDependencyGraph.model.Action;
...
import com.github.ConstructDependencyGraph.util.diffparser.api.DiffParser;
import com.github.ConstructDependencyGraph.util.diffparser.api.UnifiedDiffParser;
import com.github.ConstructDependencyGraph.util.diffparser.api.model.Diff;
import com.github.ConstructDependencyGraph.util.diffparser.api.model.Hunk;
import com.github.ConstructDependencyGraph.util.diffparser.api.model.Line;
  ...
  private DiffHunk createDiffHunkForBinaryFile(DiffFile diffFile) {
    ...
    DiffHunk diffHunk =
        new DiffHunk(
            ...
            changeType,
            new com.github.ConstructDependencyGraph.model.Hunk(
                Version.BASE,
                diffFile.getBaseRelativePath(),
                0,
                0,
  ...
  private List<DiffHunk> generateDiffHunks(
    ...
    for (Diff diff : diffs) {
      ...
      for (Hunk hunk : diff.getHunks()) {
        ...
        com.github.ConstructDependencyGraph.model.Hunk baseHunk =
            new com.github.ConstructDependencyGraph.model.Hunk(
                Version.BASE,
                ...
                baseCodeLines);
        com.github.ConstructDependencyGraph.model.Hunk currentHunk =
            new com.github.ConstructDependencyGraph.model.Hunk(
                Version.CURRENT,
