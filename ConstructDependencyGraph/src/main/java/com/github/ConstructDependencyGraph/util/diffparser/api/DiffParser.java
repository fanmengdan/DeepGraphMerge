...
/**
 * Interface to a parser that parses a textual diff between two text files. See the javadoc of the
 * implementation you want to use to see what diff format it is expecting as input.
 *
