...
public class Diff {
  ...
  /**
   * Gets the name of the first file that was compared with this Diff (the file "from" which the
   * changes were made, i.e. the "left" file of the diff).
   *
  ...
  /**
   * Gets the name of the second file that was compared with this Diff (the file "to" which the
   * changes were made, i.e. the "right" file of the diff).
   *
