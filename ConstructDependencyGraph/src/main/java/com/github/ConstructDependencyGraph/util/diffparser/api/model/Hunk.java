 ...
 */
package com.github.ConstructDependencyGraph.util.diffparser.api.model;
 ...
 *
 * <p>A Hunk consists of one or more lines that either exist only in the first file ("from line"),
 * only in the second file ("to line") or in both files ("neutral line"). Additionally, it contains
 * information about which excerpts of the compared files are compared in this Hunk in the form of
 * line ranges.
 *
